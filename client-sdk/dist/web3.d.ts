...
import { ScheduledTransfer, TransferScheduledEventLog, AddressNonceRecord, Status } from './types';
...
export declare function fetchQueuedTransfers(web3: Web3, address: `0x${string}`, status: Status): Promise<TransferScheduledEventLog[]>;
