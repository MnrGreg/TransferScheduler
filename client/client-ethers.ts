...
async function main() {
  ...
  let transferSchedulerContract = new ethers.Contract(TransferSchedulerContract, transferSchedulerABI, relaySigner);
  ...
  const permit: PermitBatchTransferFrom = {
    ...
    spender: TransferSchedulerContract,  //SPcontract
    nonce: nonce,
    deadline: deadline
  };
